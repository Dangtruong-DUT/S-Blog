...
/**
 * Check if a message contains Vietnamese text
 ...
 * @returns A time-appropriate greeting in Vietnamese
 */
...
/**
 * Extract keywords from user input for better response matching
 * @param input - User input text
 * @returns Array of extracted keywords
 */
export const extractKeywords = (input: string): string[] => {
    const stopWords = ['tôi', 'bạn', 'là', 'của', 'và', 'có', 'được', 'một', 'này', 'đó', 'với', 'để', 'từ', 'cho', 'về', 'trong', 'hay', 'gì', 'như', 'sao', 'the', 'a', 'an', 'and', 'or', 'but', 'in', 'on', 'at', 'to', 'for', 'of', 'with', 'by']
